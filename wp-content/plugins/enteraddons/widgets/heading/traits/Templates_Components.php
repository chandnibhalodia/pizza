...
trait Templates_Components {
    ...
    protected static function title() {
        ...
        if( !empty( $settings['title'] ) ) {
            ...
            echo '<'.tag_escape( $settings['tag'] ).' class="heading-title '.esc_attr( $ba ).'">'.wp_kses( $settings['title'], $allowedHtml ).'</'.tag_escape($settings['tag']).'>';
        }
    ...
    protected static function subTitle() {
        ...
        if( !empty( $settings['subtitle'] ) ) {
            echo '<'.tag_escape( $settings['subtitle_tag'] ).' class="heading-short-title">'.esc_html( $settings['subtitle'] ).'</'.tag_escape( $settings['subtitle_tag'] ).'>';
        }
