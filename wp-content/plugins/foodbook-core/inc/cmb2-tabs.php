...
if (!class_exists('CMB2_Tabs', false)) {
    ...
    class CMB2_Tabs {
        ...
        public function setup_admin_scripts() {
            ...
            wp_register_script('cmb-tabs-js', FOODBOOK_PLUGINURL.'assets/js/tabs.js', array('jquery'), self::VERSION);
            wp_enqueue_script('cmb-tabs-js');

            wp_enqueue_style('cmb2-tabs-style', FOODBOOK_PLUGINURL.'assets/css/tabs.css', array(), self::VERSION);
