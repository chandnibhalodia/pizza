<?php
function foodbook_fa_icons( $html = '' ){
  $icons = array(
	'fa-glass'=>'&#xf000;  fa-glass',
	'fa-music'=>'&#xf001;  fa-music',
	'fa-search'=>'&#xf002;  fa-search',
...
// the opt_name is set to foodbook_opt.  Please replace it if change your opt_name name.
add_action( 'redux/page/foodbook_opt/enqueue', 'foodbook_faIconFont' );
function foodbook_faIconFont() {

  //  Font awesome enqueue
  wp_enqueue_style( 'font-awesome', FOODBOOK_THEME_CSS_DIR_URI.'font-awesome.min.css', array(), '4.7', 'all' );

  // Redux admin css enqueue
  wp_enqueue_style( 'foodbook-redux-admin', FOODBOOK_THEME_DIR_URI.'inc/redux-custom-field/assist/foodbook-redux-admin.css', array(), '1.0' );

  // Redux admin js enqueue
  wp_enqueue_script( 'foodbook-redux-admin', FOODBOOK_THEME_DIR_URI.'inc/redux-custom-field/assist/foodbook-redux-admin.js', array( 'jquery' ), '1.0', true );
